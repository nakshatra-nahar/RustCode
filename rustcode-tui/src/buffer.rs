...
use rustcode_view::graphics::{Color, Modifier, Rect, Style, UnderlineStyle};
...
///
/// ```
/// use rustcode_tui::buffer::{Buffer, Cell};
/// use rustcode_view::graphics::{Rect, Color, UnderlineStyle, Style, Modifier};
///
...
impl Buffer {
    ...
    ///
    /// ```
    /// # use rustcode_tui::buffer::Buffer;
