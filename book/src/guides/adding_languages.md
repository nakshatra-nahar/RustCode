# Adding new languages to rustcode

In order to add a new language to rustcode, you will need to follow the steps
below.
...
> the
> [Language Server Wiki](https://github.com/rustcode-editor/rustcode/wiki/Language-Server-Configurations)
...
4. A list of highlight captures can be found [on the themes page](https://docs.rustcode-editor.com/themes.html#scopes).

> 💡 In rustcode, the first matching query takes precedence when evaluating
> queries, which is different from other editors such as Neovim where the last
> matching query supersedes the ones before it. See
> [this issue](https://github.com/rustcode-editor/rustcode/pull/1170#issuecomment-997294090)
> for an example.

## Common issues

- If you encounter errors when running rustcode after switching branches, you may
...
- If you are attempting to add queries and rustcode is unable to locate them, ensure that the environment variable `rustcode_RUNTIME` is set to the location of the `runtime` folder you're developing in.
