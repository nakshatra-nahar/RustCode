...
use rustcode_core::fuzzy::MATCHER;
...
use rustcode_view::{editor::SmartTabConfig, graphics::Rect, Editor};
        ...
        if !fits {
            ...
            for i in 0..win_height {
                ...
                if scroll_line <= i && i < scroll_line + scroll_height {
                    ...
                    cell.set_fg(scroll_style.fg.unwrap_or(rustcode_view::theme::Color::Reset));
                } else if !render_borders {
                    // Draw scroll track
                    cell.set_symbol(half_block);
                    cell.set_fg(scroll_style.bg.unwrap_or(rustcode_view::theme::Color::Reset));
                }
            }
        }
    }
