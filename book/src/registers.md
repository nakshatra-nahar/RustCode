...
In rustcode, registers are storage locations for text and other data, such as the
...
rustcode allows you to create your own named registers for storing text, for
example:
...
selections if the clipboard was last yanked to by the rustcode session. Otherwise
