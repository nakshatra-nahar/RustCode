...
//!
//! ```rust
//! # use rustcode_tui::widgets::Block;
//! # use rustcode_tui::text::{Span, Spans};
//! # use rustcode_view::graphics::{Color, Style};
...
//! ]);
//! ```
use rustcode_core::line_ending::str_is_line_ending;
...
impl<'a> Span<'a> {
    ...
    /// ```rust
    /// # use rustcode_tui::text::Span;
    /// # use rustcode_view::graphics::{Color, Modifier, Style};
    ...
    ///
    /// ```rust
    /// # use rustcode_tui::text::{Span, StyledGrapheme};
    /// # use rustcode_view::graphics::{Color, Modifier, Style};
