...
#[test]
fn test_treesitter_indent_rust_rustcode() {
    ...
    for file in files.split_whitespace() {
        ...
        let ignored_lines: Vec<Range<usize>> = match file {
            "rustcode-term/src/application.rs" => vec![
            ...
            "rustcode-term/src/commands.rs" => vec![
            ...
            "rustcode-term/src/commands/dap.rs" => vec![
                // Complex `format!` macro
                46..52,
            ],
            "rustcode-term/src/commands/lsp.rs" => vec![
                // Macro
                624..627,
                ...
                878..879,
                // Same as in `rustcode-term/src/commands.rs`
                1335..1343,
            ],
            "rustcode-term/src/config.rs" => vec![
                // Multiline string
                146..152,
            ],
            "rustcode-term/src/keymap.rs" => vec![
                // Complex macro (see above)
                456..470,
                // Multiline string without indent
                563..567,
            ],
            "rustcode-term/src/main.rs" => vec![
                // Multiline string
                44..70,
            ],
            "rustcode-term/src/ui/completion.rs" => vec![
                // Macro
                218..232,
            ],
            "rustcode-term/src/ui/editor.rs" => vec![
            ...
            "rustcode-term/src/ui/lsp.rs" => vec![
                // Macro
                56..61,
            ],
            "rustcode-term/src/ui/statusline.rs" => vec![
                // Same as in `rustcode-term/src/commands.rs`
                436..442,
                450..456,
            ],
...
fn test_treesitter_indent(
    ...
    std::env::set_var("rustcode_RUNTIME", runtime.to_str().unwrap());
