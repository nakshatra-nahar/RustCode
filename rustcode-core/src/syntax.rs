...
use rustcode_stdx::rope::{self, RopeSliceExt};
...
use rustcode_loader::grammar::{get_language, load_runtime_file};
...
/// In rustcode, this problem caused treesitter motions to take multiple seconds to complete in medium-sized rust files (3k loc).
///
///
