use rustcode_core::{coords_at_pos, encoding, Position};
use rustcode_lsp::lsp::DiagnosticSeverity;
use rustcode_view::document::DEFAULT_LANGUAGE_NAME;
use rustcode_view::{
...
use rustcode_view::editor::StatusLineElement as StatusLineElementID;
...
{
    match element_id {
        rustcode_view::editor::StatusLineElement::Mode => render_mode,
        rustcode_view::editor::StatusLineElement::Spinner => render_lsp_spinner,
        rustcode_view::editor::StatusLineElement::FileBaseName => render_file_base_name,
        rustcode_view::editor::StatusLineElement::FileName => render_file_name,
        rustcode_view::editor::StatusLineElement::FileAbsolutePath => render_file_absolute_path,
        rustcode_view::editor::StatusLineElement::FileModificationIndicator => {
            render_file_modification_indicator
        }
        rustcode_view::editor::StatusLineElement::ReadOnlyIndicator => render_read_only_indicator,
        rustcode_view::editor::StatusLineElement::FileEncoding => render_file_encoding,
        rustcode_view::editor::StatusLineElement::FileLineEnding => render_file_line_ending,
        rustcode_view::editor::StatusLineElement::FileType => render_file_type,
        rustcode_view::editor::StatusLineElement::Diagnostics => render_diagnostics,
        rustcode_view::editor::StatusLineElement::WorkspaceDiagnostics => render_workspace_diagnostics,
        rustcode_view::editor::StatusLineElement::Selections => render_selections,
        rustcode_view::editor::StatusLineElement::PrimarySelectionLength => {
            render_primary_selection_length
        }
        rustcode_view::editor::StatusLineElement::Position => render_position,
        rustcode_view::editor::StatusLineElement::PositionPercentage => render_position_percentage,
        rustcode_view::editor::StatusLineElement::TotalLineNumbers => render_total_line_numbers,
        rustcode_view::editor::StatusLineElement::Separator => render_separator,
        rustcode_view::editor::StatusLineElement::Spacer => render_spacer,
        rustcode_view::editor::StatusLineElement::VersionControl => render_version_control,
        rustcode_view::editor::StatusLineElement::Register => render_register,
    }
}
    ...
    F: Fn(&mut RenderContext, String, Option<Style>) + Copy,
{
    let (warnings, errors) = context
        ...
        .fold((0, 0), |mut counts, diag| {
            use rustcode_core::diagnostic::Severity;
            match diag.severity {
