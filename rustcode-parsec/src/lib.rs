...
///
/// ```
/// use rustcode_parsec::{token, Parser};
...
///
/// ```
/// use rustcode_parsec::{take_until, Parser};
...
///
/// ```
/// use rustcode_parsec::{take_while, Parser};
...
///
/// ```
/// use rustcode_parsec::{seq, Parser};
/// let parser = seq!("<", "a", ">");
...
///
/// ```
/// use rustcode_parsec::{choice, or, Parser};
...
///
/// ```
/// use rustcode_parsec::{map, Parser};
...
///
/// ```
/// use rustcode_parsec::{filter_map, take_until, Parser};
...
///
/// ```
/// use rustcode_parsec::{reparse_as, take_until, one_or_more, Parser};
...
///
/// ```
/// use rustcode_parsec::{filter, take_until, Parser};
...
///
/// ```
/// use rustcode_parsec::{optional, Parser};
...
///
/// ```
/// use rustcode_parsec::{left, Parser};
...
///
/// ```
/// use rustcode_parsec::{right, Parser};
...
///
/// ```
/// use rustcode_parsec::{zero_or_more, Parser};
...
///
/// ```
/// use rustcode_parsec::{one_or_more, Parser};
...
///
/// ```rust
/// use rustcode_parsec::{sep, Parser};
/// let parser = sep("a", ",");
