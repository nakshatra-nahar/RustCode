...
use rustcode_lsp::util::pos_to_lsp_pos;
use rustcode_stdx::rope::RopeSliceExt;
use rustcode_view::document::{Mode, SavePoint};
use rustcode_view::handlers::lsp::CompletionEvent;
use rustcode_view::{DocumentId, Editor, ViewId};
...
impl rustcode_event::AsyncHook for CompletionHandler {
...
pub fn trigger_auto_completion(
    ...
    let (view, doc): (&rustcode_view::View, &rustcode_view::Document) = current_ref!(editor);
