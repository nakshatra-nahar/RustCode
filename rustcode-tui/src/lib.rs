...
//! ```rust,no_run
//! use std::io;
//! use rustcode_tui::Terminal;
//! use rustcode_tui::backend::CrosstermBackend;
//! use rustcode_view::editor::Config;
//!
...
//! use rustcode_tui::Terminal;
//! use rustcode_tui::backend::CrosstermBackend;
//! use rustcode_tui::widgets::{Widget, Block, Borders};
//! use rustcode_tui::layout::{Layout, Constraint, Direction};
//! use rustcode_view::editor::Config;
//!
//! fn main() -> Result<(), io::Error> {
