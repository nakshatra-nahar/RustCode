...
> ⚠️ Some terminals' default key mappings conflict with rustcode's. If any of the mappings described on this page do not work as expected, check your terminal's mappings to ensure they do not conflict. See the (wiki)[https://github.com/rustcode-editor/rustcode/wiki/Terminal-Support] for known conflicts.

## Normal mode

Normal mode is the default mode when you launch rustcode. You can return to it from other modes by pressing the `Escape` key.
...
[remapping keys](https://docs.rustcode-editor.com/remapping.html#minor-modes).
...
Insert mode bindings are minimal by default. rustcode is designed to
