use rustcode_loader::grammar::{build_grammars, fetch_grammars};

fn main() {
    if std::env::var("rustcode_DISABLE_AUTO_GRAMMAR_BUILD").is_err() {
    ...
    #[cfg(windows)]
    windows_rc::link_icon_in_windows_exe("../contrib/rustcode-256p.ico");
}
