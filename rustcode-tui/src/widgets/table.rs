...
use rustcode_core::unicode::width::UnicodeWidthStr;
use rustcode_view::graphics::{Rect, Style};

/// A [`Cell`] contains the [`Text`] to be displayed in a [`Row`] of a [`Table`].
///
/// It can be created from anything that can be converted to a [`Text`].
/// ```rust
/// # use rustcode_tui::widgets::Cell;
/// # use rustcode_tui::text::{Span, Spans, Text};
/// # use rustcode_view::graphics::{Style, Modifier};
...
/// ```rust
/// # use rustcode_tui::widgets::Row;
/// Row::new(vec!["Cell1", "Cell2", "Cell3"]);
/// ```
///
/// But if you need a bit more control over individual cells, you can explicitly create [`Cell`]s:
/// ```rust
/// # use rustcode_tui::widgets::{Row, Cell};
/// # use rustcode_view::graphics::{Style, Color};
/// Row::new(vec![
///     Cell::from("Cell1"),
...
/// ```rust
/// # use rustcode_tui::widgets::{Block, Borders, Table, Row, Cell};
/// # use rustcode_tui::layout::Constraint;
/// # use rustcode_view::graphics::{Style, Color, Modifier};
/// # use rustcode_tui::text::{Text, Spans, Span};
/// Table::new(vec![
