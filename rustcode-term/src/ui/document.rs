...
use rustcode_core::doc_formatter::{DocumentFormatter, GraphemeSource, TextFormat};
use rustcode_core::graphemes::Grapheme;
use rustcode_core::str_utils::char_to_byte_idx;
use rustcode_core::syntax::Highlight;
use rustcode_core::syntax::HighlightEvent;
use rustcode_core::text_annotations::TextAnnotations;
use rustcode_core::{visual_offset_from_block, Position, RopeSlice};
use rustcode_stdx::rope::RopeSliceExt;
use rustcode_view::editor::{WhitespaceConfig, WhitespaceRenderValue};
use rustcode_view::graphics::Rect;
use rustcode_view::theme::Style;
use rustcode_view::view::ViewPosition;
use rustcode_view::Document;
...
///
/// TODO(ropey2): hopefully one day rustcode and ropey will operate entirely
