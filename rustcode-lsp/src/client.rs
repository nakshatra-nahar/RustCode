...
use rustcode_core::{find_workspace, syntax::LanguageServerFeature, ChangeSet, Rope};
...
impl Client {
    ...
    pub fn start(
        ...
        let cmd = rustcode_stdx::env::which(cmd)?;
