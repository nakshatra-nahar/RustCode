...
use rustcode_core::unicode::{segmentation::UnicodeSegmentation, width::UnicodeWidthStr};
...
impl KeyEvent {
    ...
    /// ```
    /// # use std::str::FromStr;
    /// # use rustcode_view::input::KeyEvent;
    ///
...
impl UnicodeWidthStr for KeyEvent {
    fn width(&self) -> usize {
        use rustcode_core::unicode::width::UnicodeWidthChar;
