...
use rustcode_lsp::lsp::{self, SignatureInformation};
use rustcode_stdx::rope::RopeSliceExt;
use rustcode_view::document::Mode;
use rustcode_view::events::{DocumentDidChange, SelectionDidChange};
use rustcode_view::handlers::lsp::{SignatureHelpEvent, SignatureHelpInvoked};
...
impl rustcode_event::AsyncHook for SignatureHelpHandler {
...
fn active_param_range(
    ...
    match &param.label {
        ...
        lsp::ParameterLabel::LabelOffsets([start, end]) => {
            ...
            // but highlighting in rustcode is done using byte offset.
...
pub fn show_signature_help(
    ...
    // annoyance, see https://github.com/rustcode-editor/rustcode/issues/3112
