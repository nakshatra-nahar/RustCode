...
; Functions and variables
 ...
 ; The former one works for `tree-sitter highlight` but not in rustcode/Kakoune.
 ; The latter two work in rustcode (but not Kakoune) and are a good compromise between not highlighting anything at all
