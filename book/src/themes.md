...
Create a file with the name of your theme as the file name (i.e `mytheme.toml`) and place it in your `themes` directory (i.e `~/.config/rustcode/themes` or `%AppData%\rustcode\themes` on Windows). The directory might have to be created beforehand.
...
[here](https://github.com/rustcode-editor/rustcode/blob/master/theme.toml) and
user-submitted themes
[here](https://github.com/rustcode-editor/rustcode/blob/master/runtime/themes).
